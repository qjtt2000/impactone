...
- Skyline replaced with the newly supplied transparent PNG without redraw or filtering.
- Existing interaction logic is unchanged.
- Service Worker cache bumped to `impactone-daily-v316-samplematch`.
